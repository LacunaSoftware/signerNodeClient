...
const NotificationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        apiNotificationsFlowActionReminderPost: (body, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        apiUsersNotifyPendingPost: (body, options = {}) => __awaiter(this, void 0, void 0, function* () {
...
const NotificationsApiFp = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiNotificationsFlowActionReminderPost(body, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield (0, exports.NotificationsApiAxiosParamCreator)(configuration).apiNotificationsFlowActionReminderPost(body, options);
         ...
         * @throws {RequiredError}
         */
        apiUsersNotifyPendingPost(body, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield (0, exports.NotificationsApiAxiosParamCreator)(configuration).apiUsersNotifyPendingPost(body, options);
                return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                    const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                    return axios.request(axiosRequestArgs);
                };
...
const NotificationsApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        apiNotificationsFlowActionReminderPost(body, options) {
            return __awaiter(this, void 0, void 0, function* () {
                return (0, exports.NotificationsApiFp)(configuration).apiNotificationsFlowActionReminderPost(body, options).then((request) => request(axios, basePath));
            });
        },
        /**
         *
        ...
        apiUsersNotifyPendingPost(body, options) {
            return __awaiter(this, void 0, void 0, function* () {
                return (0, exports.NotificationsApiFp)(configuration).apiUsersNotifyPendingPost(body, options).then((request) => request(axios, basePath));
            });
        },
    };
};
...
class NotificationsApi extends base_1.BaseAPI {
    ...
    apiNotificationsFlowActionReminderPost(body, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, exports.NotificationsApiFp)(this.configuration).apiNotificationsFlowActionReminderPost(body, options).then((request) => request(this.axios, this.basePath));
        });
    }
    /**
     *
    ...
    apiUsersNotifyPendingPost(body, options) {
        return __awaiter(this, void 0, void 0, function* () {
            return (0, exports.NotificationsApiFp)(this.configuration).apiUsersNotifyPendingPost(body, options).then((request) => request(this.axios, this.basePath));
        });
    }
}
