...
var UploadApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        apiUploadsBytesPost: function (body_1) {
            var args_1 = [];
         ...
         * @throws {RequiredError}
         */
        apiUploadsPostForm: function (file_1) {
            var args_1 = [];
            for (var _i = 1; _i < arguments.length; _i++) {
                args_1[_i - 1] = arguments[_i];
            }
            return __awaiter(_this, __spreadArray([file_1], args_1, true), void 0, function (file, options) {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, localVarFormParams, localVarApiKeyValue, _a, query, key, key, headersFromBaseOptions;
                if (options === void 0) { options = {}; }
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
...
var UploadApiFp = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiUploadsPostForm: function (file, options) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarAxiosArgs;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.UploadApiAxiosParamCreator)(configuration).apiUploadsPostForm(file, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
var UploadApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        apiUploadsPostForm: function (file, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.UploadApiFp)(configuration).apiUploadsPostForm(file, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var UploadApi = /** @class */ (function (_super) {
     ...
     * @memberof UploadApi
     */
    UploadApi.prototype.apiUploadsPostForm = function (file, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.UploadApiFp)(this.configuration).apiUploadsPostForm(file, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return UploadApi;
