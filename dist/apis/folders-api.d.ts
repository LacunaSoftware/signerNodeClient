...
export declare const FoldersApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    apiFoldersIdDeletePost: (id: string, body?: FoldersFolderDeleteRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    apiFoldersPost: (body?: FoldersFolderCreateRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const FoldersApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    apiFoldersGet(Q?: string, limit?: number, offset?: number, order?: PaginationOrders, filterByParent?: boolean, parentId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PaginatedSearchResponseFoldersFolderInfoModel>>>;
    /**
     *
     * @summary Deletes a folder.
     * @param {string} id Id of the folder to be deleted
     ...
     * @throws {RequiredError}
     */
    apiFoldersIdDeletePost(id: string, body?: FoldersFolderDeleteRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>>;
    /**
     *
     * @summary Retrieves the folder's info.
     * @param {string} id Folder id
     ...
     * @throws {RequiredError}
     */
    apiFoldersIdGet(id: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<FoldersFolderOrganizationModel>>>;
    /**
     *
     * @summary Creates a folder.
     * @param {FoldersFolderCreateRequest} [body]
     ...
     * @throws {RequiredError}
     */
    apiFoldersPost(body?: FoldersFolderCreateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<FoldersFolderInfoModel>>>;
};
/**
...
export declare const FoldersApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    apiFoldersGet(Q?: string, limit?: number, offset?: number, order?: PaginationOrders, filterByParent?: boolean, parentId?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PaginatedSearchResponseFoldersFolderInfoModel>>;
    /**
     *
     * @summary Deletes a folder.
     * @param {string} id Id of the folder to be deleted
     ...
     * @throws {RequiredError}
     */
    apiFoldersIdDeletePost(id: string, body?: FoldersFolderDeleteRequest, options?: AxiosRequestConfig): Promise<AxiosResponse<void>>;
    /**
     *
     * @summary Retrieves the folder's info.
     * @param {string} id Folder id
     ...
     * @throws {RequiredError}
     */
    apiFoldersIdGet(id: string, options?: AxiosRequestConfig): Promise<AxiosResponse<FoldersFolderOrganizationModel>>;
    /**
     *
     * @summary Creates a folder.
     * @param {FoldersFolderCreateRequest} [body]
     ...
     * @throws {RequiredError}
     */
    apiFoldersPost(body?: FoldersFolderCreateRequest, options?: AxiosRequestConfig): Promise<AxiosResponse<FoldersFolderInfoModel>>;
};
/**
