...
export declare const UploadApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    apiUploadsBytesPost: (body?: UploadsUploadBytesRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    apiUploadsPostForm: (filename: string, filepath: any, contentType: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const UploadApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    apiUploadsBytesPost(body?: UploadsUploadBytesRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<UploadsUploadBytesModel>>>;
    /**
     * The id returned by this API should be used as paremeter to other APIs.  You may also use the location property to display a preview of the uploaded file.
     * @summary Uploads a file by sending a multipart/form-data request
     * @param {any} [file]
     ...
     * @throws {RequiredError}
     */
    apiUploadsPostForm(filename: string, filepath: any, contentType: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<FileModel>>>;
};
/**
...
export declare const UploadApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    apiUploadsBytesPost(body?: UploadsUploadBytesRequest, options?: AxiosRequestConfig): Promise<AxiosResponse<UploadsUploadBytesModel>>;
    /**
     * The id returned by this API should be used as paremeter to other APIs.  You may also use the location property to display a preview of the uploaded file.
     * @summary Uploads a file by sending a multipart/form-data request
     * @param {any} [file]
     ...
     * @throws {RequiredError}
     */
    apiUploadsPostForm(filename: string, filepath: any, contentType: string, options?: AxiosRequestConfig): Promise<AxiosResponse<FileModel>>;
};
/**
