...
var OrganizationsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        apiOrganizationsUsersPost: function (body_1) {
            var args_1 = [];
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (userId === null || userId === undefined) {
                                throw new base_1.RequiredError('userId', 'Required parameter userId was null or undefined when calling apiOrganizationsUsersUserIdDelete.');
                            }
...
var OrganizationsApiFp = function (configuration) {
    return {
        ...
        apiOrganizationsUsersGet: function (Q, limit, offset, order, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OrganizationsApiAxiosParamCreator)(configuration).apiOrganizationsUsersGet(Q, limit, offset, order, options)];
                        case 1:
         ...
         * @throws {RequiredError}
         */
        apiOrganizationsUsersPost: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarAxiosArgs;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OrganizationsApiAxiosParamCreator)(configuration).apiOrganizationsUsersPost(body, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
        ...
        apiOrganizationsUsersUserIdDelete: function (userId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.OrganizationsApiAxiosParamCreator)(configuration).apiOrganizationsUsersUserIdDelete(userId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
var OrganizationsApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        apiOrganizationsUsersGet: function (Q, limit, offset, order, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OrganizationsApiFp)(configuration).apiOrganizationsUsersGet(Q, limit, offset, order, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        apiOrganizationsUsersPost: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OrganizationsApiFp)(configuration).apiOrganizationsUsersPost(body, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        apiOrganizationsUsersUserIdDelete: function (userId, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.OrganizationsApiFp)(configuration).apiOrganizationsUsersUserIdDelete(userId, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var OrganizationsApi = /** @class */ (function (_super) {
    ...
    OrganizationsApi.prototype.apiOrganizationsUsersGet = function (Q, limit, offset, order, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OrganizationsApiFp)(this.configuration).apiOrganizationsUsersGet(Q, limit, offset, order, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof OrganizationsApi
     */
    OrganizationsApi.prototype.apiOrganizationsUsersPost = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OrganizationsApiFp)(this.configuration).apiOrganizationsUsersPost(body, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
    ...
    OrganizationsApi.prototype.apiOrganizationsUsersUserIdDelete = function (userId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.OrganizationsApiFp)(this.configuration).apiOrganizationsUsersUserIdDelete(userId, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
