...
export declare const OrganizationsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersPost: (body?: OrganizationsOrganizationUserPostRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     *
...
export declare const OrganizationsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersGet(Q?: string, limit?: number, offset?: number, order?: PaginationOrders, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PaginatedSearchResponseOrganizationsOrganizationUserModel>>>;
    /**
     *
     * @summary Adds a user to the organization
     * @param {OrganizationsOrganizationUserPostRequest} [body]
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersPost(body?: OrganizationsOrganizationUserPostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<OrganizationsOrganizationUserModel>>>;
    /**
     *
     * @summary Deletes a user from organization
     * @param {string} userId
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersUserIdDelete(userId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<void>>>;
};
/**
...
export declare const OrganizationsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersGet(Q?: string, limit?: number, offset?: number, order?: PaginationOrders, options?: AxiosRequestConfig): Promise<AxiosResponse<PaginatedSearchResponseOrganizationsOrganizationUserModel>>;
    /**
     *
     * @summary Adds a user to the organization
     * @param {OrganizationsOrganizationUserPostRequest} [body]
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersPost(body?: OrganizationsOrganizationUserPostRequest, options?: AxiosRequestConfig): Promise<AxiosResponse<OrganizationsOrganizationUserModel>>;
    /**
     *
     * @summary Deletes a user from organization
     * @param {string} userId
     ...
     * @throws {RequiredError}
     */
    apiOrganizationsUsersUserIdDelete(userId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<void>>;
};
/**
