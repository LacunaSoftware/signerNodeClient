...
var UploadApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        apiUploadsBytesPost: function (body, options) {
         ...
         * @throws {RequiredError}
         */
        apiUploadsPostForm: function (filename, filepath, contentType, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, localVarFormParams, localVarApiKeyValue, _a, stream, query, key, key, headersFromBaseOptions;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
    ...
    return {
        ...
        apiUploadsBytesPost: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.UploadApiAxiosParamCreator)(configuration).apiUploadsBytesPost(body, options)];
                        case 1:
        ...
        apiUploadsPostForm: function (filename, filepath, contentType, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.UploadApiAxiosParamCreator)(configuration).apiUploadsPostForm(filename, filepath, contentType, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1["default"]; }
...
var UploadApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        apiUploadsBytesPost: function (body, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.UploadApiFp)(configuration).apiUploadsBytesPost(body, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
        /**
        ...
        apiUploadsPostForm: function (filename, filepath, contentType, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.UploadApiFp)(configuration).apiUploadsPostForm(filename, filepath, contentType, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        }
    };
...
var UploadApi = /** @class */ (function (_super) {
     ...
     * @memberof UploadApi
     */
    UploadApi.prototype.apiUploadsBytesPost = function (body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.UploadApiFp)(this.configuration).apiUploadsBytesPost(body, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    /**
     ...
     * @memberof UploadApi
     */
    UploadApi.prototype.apiUploadsPostForm = function (filename, filepath, contentType, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.UploadApiFp)(this.configuration).apiUploadsPostForm(filename, filepath, contentType, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return UploadApi;
