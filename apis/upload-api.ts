...
export const UploadApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiUploadsPostForm: async (file?: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const UploadApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiUploadsPostForm(file?: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<FileModel>>> {
            const localVarAxiosArgs = await UploadApiAxiosParamCreator(configuration).apiUploadsPostForm(file, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UploadApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiUploadsPostForm(file?: any, options?: AxiosRequestConfig): Promise<AxiosResponse<FileModel>> {
            return UploadApiFp(configuration).apiUploadsPostForm(file, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UploadApi extends BaseAPI {
     ...
     * @memberof UploadApi
     */
    public async apiUploadsPostForm(file?: any, options?: AxiosRequestConfig) : Promise<AxiosResponse<FileModel>> {
        return UploadApiFp(this.configuration).apiUploadsPostForm(file, options).then((request) => request(this.axios, this.basePath));
    }
}
